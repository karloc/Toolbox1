...
/**
 * Created by Karlo on 19.2.2017..
 */

public class Location extends AppCompatActivity implements ActionBar.TabListener, OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        btnRestaurant.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Location.this,"Nearby Restaurants", Toast.LENGTH_LONG).show();
            }
        });
        ...
        btnSchool.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NearbyPlacesData getNearbyPlacesData = new NearbyPlacesData();
                getNearbyPlacesData.execute(DataTransfer);
                Toast.makeText(Location.this,"Nearby Schools", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void onLocationChanged(android.location.Location location) {
        ...
        Toast.makeText(Location.this,"Your Current Location", Toast.LENGTH_LONG).show();
